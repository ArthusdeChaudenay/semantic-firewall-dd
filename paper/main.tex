...
% Typography. LaTeX's defaults tolerate a single line stranded at the top or bottom of
% a column, which left page 2 opening on "uninterpretable." and page 3 on "ing.".
% Forbidding club and widow lines, and refusing to carry a hyphenated word across a
% page break, removes both.
\clubpenalty=10000
\widowpenalty=10000
...
\begin{table}[h]
\centering\small
\begin{tabular}{@{}p{1.6cm}p{1.9cm}p{1.5cm}p{1.4cm}@{}}
\toprule
